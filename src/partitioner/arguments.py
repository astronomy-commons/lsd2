...
class PartitionArguments:
    def from_command_line(self):
        ...
        parser.add_argument('catalog_name', help='short name for the catalog that will be used for the output directory')
        parser.add_argument('input_path', help='path prefix for unpartitioned input files')
        parser.add_argument('output_path', help='path prefix for partitioned output and metadata files')
