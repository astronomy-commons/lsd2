...
def download_gaia(client=None):
    ...
    c.hips_import(
        file_source="/epyc/data/gaia_edr3_csv/",
        fmt="csv.gz",
        ra_kw="ra",
        dec_kw="dec",
        id_kw="source_id",
...
def download_sdss(client=None):
    ...
    c.hips_import(
        file_source="/epyc/data/sdss_parquet/",
        fmt="parquet",
        ra_kw="RA",
        dec_kw="DEC",
        id_kw="ID",
...
def download_des(client=None):
    ...
    c.hips_import(
        file_source="https://desdr-server.ncsa.illinois.edu/despublic/y1a1_files/gold_catalogs/",
        fmt="fits",
        ra_kw="RA",
        dec_kw="DEC",
        id_kw="COADD_OBJECTS_ID",
        debug=True,
        verbose=True,
        threshold=1_000_000,
        client=client,
...
def download_ztf(client=None):
    ...
    c.hips_import(
        file_source="/data/epyc/projects/lsd2/pzwarehouse/ztf_dr7/",
        fmt="parquet",
        debug=True,
        ra_kw="ra",
        dec_kw="dec",
...
def download_ps1(client=None):
    ...
    c.partition_from_source(
        file_source="/epyc/data/ps1_skinny/",
        fmt="csv.gz",
        debug=True,
        ra_kw=5,
        dec_kw=6,
...
if __name__ == "__main__":
    ...
    client = Client(
        local_directory="/epyc/projects3/sam_hipscat/",
        n_workers=4,
